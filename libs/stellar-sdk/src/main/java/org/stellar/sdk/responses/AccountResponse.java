...
public class AccountResponse extends Response implements org.stellar.sdk.TransactionBuilderAccount {
  ...
  public static class Balance {
    ...
    public Balance(String asset_type, String assetCode, String assetIssuer, String balance, String limit, String buyingLiabilities, String sellingLiabilities, Boolean isAuthorized, Integer lastModifiedLedger) {
      this.asset_type = checkNotNull(asset_type, "assertType cannot be null");
