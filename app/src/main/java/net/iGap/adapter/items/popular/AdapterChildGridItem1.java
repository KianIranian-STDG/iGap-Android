...
public class AdapterChildGridItem1 extends RecyclerView.Adapter<AdapterChildGridItem1.ChildGridItemViewHolder> {
    private List<Channel> channelList = new ArrayList<>();
    private Context context;

    public AdapterChildGridItem1(Context context) {
    ...
    public ChildGridItemViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(context).inflate(R.layout.item_popular_channel_rv_grid_child1, viewGroup, false);
