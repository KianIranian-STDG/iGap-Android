...
public class Type6ViewHolder extends BaseViewHolder {
    ...
    public Type6ViewHolder(PollAdapter pollAdapter, @NonNull View itemView) {
        ...
        tick0 = itemView.findViewById(R.id.type6_tick0);
        tick1 = itemView.findViewById(R.id.type6_tick1);
        tick2 = itemView.findViewById(R.id.type6_tick2);
    }
