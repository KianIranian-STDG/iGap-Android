...
import net.iGap.webrtc.concurent.SettableFuture;
...
public class PeerConnectionWrapper {
    ...
    public PeerConnectionWrapper(@NonNull Context context, @NonNull PeerConnectionFactory factory, @NonNull PeerConnection.Observer observer, @NonNull VideoRenderer.Callbacks localRenderer, @NonNull List<PeerConnection.IceServer> turnServers, boolean hideIp) {
        ...
        //for (PeerConnection.IceServer ice : turnServers) {
        //    iceServers.add(ice);
        //}
        ...
        this.peerConnection = factory.createPeerConnection(iceServers, constraints, observer);
        this.videoCapturer = createVideoCapturer(context);

        final MediaStream mediaStream = factory.createLocalMediaStream("ARDAMS");
        ...
        Log.i("WWW", "peerConnection : " + peerConnection);
