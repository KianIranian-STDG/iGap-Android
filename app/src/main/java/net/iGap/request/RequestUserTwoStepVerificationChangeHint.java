...
public class RequestUserTwoStepVerificationChangeHint {
    ...
    public void changeHint(String password, String hint, TwoStepVerificationChangeHintCallback callback) {
        ...
        RequestWrapper requestWrapper = new RequestWrapper(142, builder, callback);
        try {
