...
public class RequestGroupEdit {
    ...
    public void groupEdit(long roomId, String name, String description, OnGroupEdit callback) {
        ...
        RequestWrapper requestWrapper = new RequestWrapper(305, builder, callback);
        try {
