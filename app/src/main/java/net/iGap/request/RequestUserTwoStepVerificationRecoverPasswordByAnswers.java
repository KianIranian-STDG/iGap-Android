...
public class RequestUserTwoStepVerificationRecoverPasswordByAnswers {
    ...
    public void RecoveryPasswordByAnswer(String answerOne, String answerTwo, TwoStepVerificationRecoverPasswordByAnswersCallback callback) {
        ...
        RequestWrapper requestWrapper = new RequestWrapper(140, builder, callback);
        try {
