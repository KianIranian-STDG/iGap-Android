...
public class RequestUserProfileSetEmail {
    ...
    public void setUserProfileEmail(String email, OnUserProfileSetEmailResponse callback) {
        ...
        RequestWrapper requestWrapper = new RequestWrapper(103, userProfileEmail, callback);
        try {
