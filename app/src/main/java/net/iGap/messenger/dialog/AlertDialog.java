...
public class AlertDialog extends Dialog implements Drawable.Callback {
    ...
    public AlertDialog(@NonNull Context context, int progressStyle) {
        super(context, R.style.TransparentDialog);

        backgroundPaddings = new Rect();
        if (progressStyle != 3) {
            shadowDrawable = context.getResources().getDrawable(R.drawable.popup_fixed_alert).mutate();
            shadowDrawable.setColorFilter(new PorterDuffColorFilter(Theme.getColor(Theme.key_popup_background), PorterDuff.Mode.MULTIPLY));
    ...
    private void showCancelAlert() {
        ...
        builder.setMessage("آیا پروسه بسته شود؟");
        builder.setPositiveButton("منتظر میمانم", null);
        builder.setNegativeButton("بستن", (dialogInterface, i) -> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LinearLayout containerView = new LinearLayout(getContext()) {
            ...
            protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
                if (progressViewStyle == 3) {
                    ...
                    if (lastScreenWidth != AndroidUtils.displaySize.x) {
                        G.runOnUiThread(() -> {
                            lastScreenWidth = AndroidUtils.displaySize.x;
                            final int calculatedWidth = AndroidUtils.displaySize.x - LayoutCreator.dp(56);
                            int maxWidth;
                            if (getContext().getResources().getBoolean(R.bool.isTablet)) {
                                maxWidth = LayoutCreator.dp(446);
                            } else {
        ...
        if (title != null) {
            ...
            titleTextView.setTypeface(ResourcesCompat.getFont(G.context, R.font.main_font));
        ...
        if (secondTitle != null && title != null) {
            ...
            secondTitleTextView.setTextColor(Theme.getColor(Theme.key_title_text));
        ...
        if (subtitle != null) {
            ...
            subtitleTextView.setTextColor(Theme.getColor(Theme.key_subtitle_text));
            subtitleTextView.setTypeface(ResourcesCompat.getFont(titleTextView.getContext(), R.font.main_font));
        ...
        messageTextView.setTypeface(ResourcesCompat.getFont(getContext(), R.font.main_font));
        messageTextView.setTextColor(Theme.getColor(Theme.key_default_text));
        messageTextView.setTextSize(TypedValue.COMPLEX_UNIT_DIP, 14);

        messageTextView.setTypeface(ResourcesCompat.getFont(messageTextView.getContext(), R.font.main_font));

        messageTextView.setLinkTextColor(Theme.getColor(Theme.key_link_text));
        ...
        if (progressViewStyle == 1) {
            ...
            progressView.setProgressColor(0xff777700);
            ...
            lineProgressView.setProgressColor(0xff777700);
            ...
            lineProgressViewPercent.setTypeface(ResourcesCompat.getFont(G.context, R.font.main_font));
            ...
            progressViewContainer = new FrameLayout(getContext());
            progressViewContainer.setBackgroundDrawable(Theme.createRoundRectDrawable(LayoutCreator.dp(18), Theme.getColor(Theme.key_popup_background)));
        ...
        if (hasButtons) {
            ...
            if (positiveButtonText != null) {
                ...
                textView.setTypeface(ResourcesCompat.getFont(G.context, R.font.main_font));
                textView.setText(positiveButtonText.toString().toUpperCase());
                textView.setBackgroundDrawable(Theme.getRoundRectSelectorDrawable(Theme.getColor(Theme.key_popup_background)));
            ...
            if (negativeButtonText != null) {
                ...
                textView.setBackground(Theme.getRoundRectSelectorDrawable(Theme.getColor(Theme.key_button_background)));
                textView.setPadding(LayoutCreator.dp(10), 0, LayoutCreator.dp(10), 0);
                buttonsLayout.addView(textView, LayoutCreator.createFrame(LayoutCreator.WRAP_CONTENT, 36, Gravity.TOP | Gravity.RIGHT));
                textView.setOnClickListener(v -> {
        ...
        if (progressViewStyle == 3) {
            ...
            lastScreenWidth = AndroidUtils.displaySize.x;
            final int calculatedWidth = AndroidUtils.displaySize.x - LayoutCreator.dp(48);
            int maxWidth;
            if (getContext().getResources().getBoolean(R.bool.isTablet)) {
                maxWidth = LayoutCreator.dp(446);
            } else {
    ...
    public static Builder createRadialDialogBuilder(@NonNull Context context) {
        return new Builder(context, 1);
    }

    public static Builder createNormalDialogBuilder(@NonNull Context context) {
        return new Builder(context, 0);
    }

    public static Builder createInlineBuilder(@NonNull Context context) {
        return new Builder(context, 3);
    }

    public static Builder createLineDialogBuilder(@NonNull Context context) {
    ...
    public static class AlertDialogCell extends FrameLayout {
        ...
        public AlertDialogCell(Context context) {
            ...
            setBackground(Theme.createSelectorDrawable(Theme.getColor(Theme.key_popup_background), 2));
