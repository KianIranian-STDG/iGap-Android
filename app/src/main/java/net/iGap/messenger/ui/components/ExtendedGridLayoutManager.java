...
public class ExtendedGridLayoutManager extends GridLayoutManager {
    ...
    private final SparseIntArray itemSpans = new SparseIntArray();
    private final SparseIntArray itemsToRow = new SparseIntArray();
    ...
    private void prepareLayout(float viewPortAvailableSize) {
        ...
        final int preferredRowSize = LayoutCreator.dp(100);
