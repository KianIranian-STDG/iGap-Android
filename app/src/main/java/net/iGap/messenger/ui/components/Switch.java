...
public class Switch extends View {
    ...
    private String trackColorKey = Theme.key_light_red;
    private String trackCheckedColorKey = Theme.key_light_theme_color;
    private String thumbColorKey = Theme.key_window_background;
    private String thumbCheckedColorKey = Theme.key_window_background;
    ...
    public Switch(Context context) {
        ...
        paint2.setStrokeWidth(LayoutCreator.dp(2));
    }
    ...
    public void setDrawRipple(boolean value) {
        ...
        if (rippleDrawable == null) {
            ...
            if (Build.VERSION.SDK_INT >= 23) {
                ...
                maskDrawable = new Drawable() {
                    ...
                    public void draw(Canvas canvas) {
                        ...
                        canvas.drawCircle(bounds.centerX(), bounds.centerY(), LayoutCreator.dp(18), ripplePaint);
                    }
            ...
            if (Build.VERSION.SDK_INT >= 23) {
                rippleDrawable.setRadius(LayoutCreator.dp(18));
            }
            rippleDrawable.setCallback(this);
        }
        if (isChecked && colorSet != 2 || !isChecked && colorSet != 1) {
            int color = Theme.getColor(Theme.key_light_theme_color);
        ...
        if (Build.VERSION.SDK_INT >= 28 && value) {
            rippleDrawable.setHotspot(isChecked ? 0 : LayoutCreator.dp(100), LayoutCreator.dp(18));
        }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        int width = LayoutCreator.dp(31);
        int thumb = LayoutCreator.dp(20);
        int x = (getMeasuredWidth() - width) / 2;
        float y = (getMeasuredHeight() - LayoutCreator.dpf2(14)) / 2;
        int tx = x + LayoutCreator.dp(7) + (int) (LayoutCreator.dp(17) * progress);
        ...
        for (int a = 0; a < 2; a++) {
            ...
            rectF.set(x, y, x + width, y + LayoutCreator.dpf2(14));
            canvasToDraw.drawRoundRect(rectF, LayoutCreator.dpf2(7), LayoutCreator.dpf2(7), paint);
            canvasToDraw.drawCircle(tx, ty, LayoutCreator.dpf2(10), paint);
            if (a == 0 && rippleDrawable != null) {
                rippleDrawable.setBounds(tx - LayoutCreator.dp(18), ty - LayoutCreator.dp(18), tx + LayoutCreator.dp(18), ty + LayoutCreator.dp(18));
        ...
        for (int a = 0; a < 2; a++) {
            ...
            canvasToDraw.drawCircle(tx, ty, LayoutCreator.dp(8), paint);
            if (a == 0) {
                if (iconDrawable != null) {
                    ...
                    tx -= LayoutCreator.dp(10.8f) - LayoutCreator.dp(1.3f) * progress;
                    ty -= LayoutCreator.dp(8.5f) - LayoutCreator.dp(0.5f) * progress;
                    int startX2 = (int) LayoutCreator.dpf2(4.6f) + tx;
                    int startY2 = (int) (LayoutCreator.dpf2(9.5f) + ty);
                    int endX2 = startX2 + LayoutCreator.dp(2);
                    int endY2 = startY2 + LayoutCreator.dp(2);

                    int startX = (int) LayoutCreator.dpf2(7.5f) + tx;
                    int startY = (int) LayoutCreator.dpf2(5.4f) + ty;
                    int endX = startX + LayoutCreator.dp(7);
                    int endY = startY + LayoutCreator.dp(7);
                    ...
                    startX = (int) LayoutCreator.dpf2(7.5f) + tx;
                    startY = (int) LayoutCreator.dpf2(12.5f) + ty;
                    endX = startX + LayoutCreator.dp(7);
                    endY = startY - LayoutCreator.dp(7);
                    canvasToDraw.drawLine(startX, startY, endX, endY, paint2);
                } else if (drawIconType == 2 || iconAnimator != null) {
                    paint2.setAlpha((int) (255 * (1.0f - iconProgress)));
                    canvasToDraw.drawLine(tx, ty, tx, ty - LayoutCreator.dp(5), paint2);
                    canvasToDraw.save();
                    canvasToDraw.rotate(-90 * iconProgress, tx, ty);
                    canvasToDraw.drawLine(tx, ty, tx + LayoutCreator.dp(4), ty, paint2);
