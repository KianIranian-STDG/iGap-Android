    ...
    public void create(StaticLayout hintLayout, CharSequence hint, CharSequence text, TextPaint paint) {
        if (hintLayout != null && !hint.equals(text)) {
            ...
            if (startFrom >= 0) {
                ...
                animateInLayout = new StaticLayout(inStr, paint, LayoutCreator.dp(400), Layout.Alignment.ALIGN_NORMAL, 1.0f, 0, false);
                animateStableLayout = new StaticLayout(stabeStr, paint, LayoutCreator.dp(400), Layout.Alignment.ALIGN_NORMAL, 1.0f, 0, false);
                ...
                animateInLayout = new StaticLayout(text, paint, LayoutCreator.dp(400), Layout.Alignment.ALIGN_NORMAL, 1.0f, 0, false);
                animateOutLayout = new StaticLayout(hint, paint, LayoutCreator.dp(400), Layout.Alignment.ALIGN_NORMAL, 1.0f, 0, false);
