...
public class MusicAndCallInfoStrip extends FrameLayout implements EventManager.EventDelegate {
    ...
    public MusicAndCallInfoStrip(@NonNull Context context, BaseFragment fragment) {
        super(context);
        setVisibility(GONE);
        ...
        musicContainer = new FrameLayout(context);
        musicContainer.setTag(MEDIA_TAG);
        musicContainer.setOnClickListener(view -> listener.clickListener((Integer) musicContainer.getTag()));

        playIconView = new IconView(context);
        playIconView.setTextColor(Theme.getColor(Theme.key_dark_theme_color));
        ...
        musicContainer.addView(playIconView, LayoutCreator.createFrame(LayoutCreator.WRAP_CONTENT, LayoutCreator.MATCH_PARENT, Gravity.LEFT, 10, 0, 0, 0));
        ...
        musicTitle.setTextColor(Theme.getColor(Theme.key_dark_theme_color));
        musicTitle.setGravity(Gravity.CENTER_VERTICAL);
        musicContainer.addView(musicTitle, LayoutCreator.createFrame(LayoutCreator.WRAP_CONTENT, LayoutCreator.MATCH_PARENT, Gravity.LEFT | Gravity.CENTER_VERTICAL, 46, 0, 46, 0));
        ...
        closeIconView.setTextColor(Theme.getColor(Theme.key_default_text));
        ...
        musicContainer.addView(closeIconView, LayoutCreator.createFrame(LayoutCreator.WRAP_CONTENT, LayoutCreator.MATCH_PARENT, Gravity.RIGHT, 5, 0, 10, 0));
        ...
        callIconView.setTextColor(Theme.getColor(Theme.key_dark_theme_color));
        ...
        callerName.setTextColor(Theme.getColor(Theme.key_dark_theme_color));
        ...
        addView(musicContainer, LayoutCreator.createFrame(LayoutCreator.MATCH_PARENT, LayoutCreator.MATCH_PARENT));
    }
    ...
    private void didMediaChanged() {
        ...
        if (!needShowCall) {
            if (needShowMedia) {
                ...
                musicContainer.setBackgroundColor(Theme.getColor(Theme.key_popup_background));
    ...
    private void didCallChange() {
        ...
        if (needShowCall) {
            ...
            if (callerInfo != null) {
                ...
                final int from = Theme.getColor(Theme.key_dark_theme_color);  // TODO: 5/1/21 These colors must change in future
                final int to = Theme.getColor(Theme.key_dark_theme_color);
