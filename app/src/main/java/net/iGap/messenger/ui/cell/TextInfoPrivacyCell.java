...
public class TextInfoPrivacyCell extends FrameLayout {
    ...
    private String linkTextColorKey = Theme.key_link_text;
    ...
    public TextInfoPrivacyCell(Context context, int padding) {
        ...
        textView.setPadding(0, LayoutCreator.dp(10), 0, LayoutCreator.dp(17));
        ...
        addView(textView, LayoutCreator.createFrame(LayoutCreator.MATCH_PARENT, LayoutCreator.WRAP_CONTENT, (G.isAppRtl ? Gravity.RIGHT : Gravity.LEFT) | Gravity.TOP, padding, 0, padding, 0));
    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        if (fixedSize != 0) {
            super.onMeasure(MeasureSpec.makeMeasureSpec(MeasureSpec.getSize(widthMeasureSpec), MeasureSpec.EXACTLY), MeasureSpec.makeMeasureSpec(LayoutCreator.dp(fixedSize), MeasureSpec.EXACTLY));
        } else {
    ...
    public void setText(CharSequence text) {
        if (!TextUtils.equals(text, this.text)) {
            this.text = text;
            if (text == null) {
                textView.setPadding(0, LayoutCreator.dp(2), 0, 0);
            } else {
                textView.setPadding(0, LayoutCreator.dp(topPadding), 0, LayoutCreator.dp(bottomPadding));
            }
