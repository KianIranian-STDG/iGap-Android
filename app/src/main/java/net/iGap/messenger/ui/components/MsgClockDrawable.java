...
public class MsgClockDrawable extends Drawable {
    ...
    public MsgClockDrawable() {
        ...
        paint.setStrokeWidth(LayoutCreator.dp(1f));
    ...
    public void draw(Canvas canvas) {
        ...
        canvas.drawCircle(bounds.centerX(), bounds.centerY(), (r >> 1) - LayoutCreator.dp(0.5f), paint);
        ...
        canvas.drawLine(bounds.centerX(), bounds.centerY(), bounds.centerX(), bounds.centerY() - LayoutCreator.dp(3), paint);
        canvas.restore();

        canvas.save();
        canvas.rotate(360 * ((currentTime - startTime) % rotateHourTime) / rotateHourTime, bounds.centerX(), bounds.centerY());
        canvas.drawLine(bounds.centerX(), bounds.centerY(), bounds.centerX() + LayoutCreator.dp(2.3f), bounds.centerY(), paint);
        canvas.restore();
    }
