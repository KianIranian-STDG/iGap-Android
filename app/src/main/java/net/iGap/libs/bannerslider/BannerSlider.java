...
public class BannerSlider extends FrameLayout {
    ...
    public BannerSlider(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        if (attributeSet != null) {
            ...
            try {
                config = new Config.Builder(getContext())
                        .animateIndicators(typedArray.getBoolean(R.styleable.BannerSlider_slider_animateIndicators, true))
                        .emptyView(typedArray.getResourceId(R.styleable.BannerSlider_slider_emptyView, Config.NOT_SELECTED))
                        .indicatorSize(typedArray.getDimensionPixelSize(R.styleable.BannerSlider_slider_indicatorSize, 0))
                        .loopSlides(typedArray.getBoolean(R.styleable.BannerSlider_slider_loopSlides, false))
                        .slideChangeInterval(typedArray.getInteger(R.styleable.BannerSlider_slider_interval, 0))
                        .selectedSlideIndicator(typedArray.getDrawable(R.styleable.BannerSlider_slider_selectedSlideIndicator))
                        .unselectedSlideIndicator(typedArray.getDrawable(R.styleable.BannerSlider_slider_unselectedSlideIndicator))
