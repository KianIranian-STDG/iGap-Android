...
public interface MobileBankApi {
    ...
    @POST("card/get-cards")
    @FormUrlEncoded
    Call<BaseMobileBankResponse<List<BankCardModel>>> getUserCards(@Header("ParsianAuth") String token,
    ...
    @FormUrlEncoded
    Call<BaseMobileBankResponse<List<BankAccountModel>>> getUserDeposits(@Header("ParsianAuth") String token,
                                                                         @Field("deposit_numbers") String depositNumber);

    @POST("card/get-deposits")
    @FormUrlEncoded
    Call<BaseMobileBankResponse<List<BankCardDepositsModel>>> getCardsDeposits(@Header("ParsianAuth") String token,
                                                                               @Field("pan") String cardNumber);

    @POST("card/convert-card-to-iban")
    @FormUrlEncoded
    Call<BaseMobileBankResponse<List<String>>> getShebaNumber(@Header("ParsianAuth") String token,
                                                              @Field("pan") String cardNumber);

    @POST("deposit/convert-deposit-to-iban")
    @FormUrlEncoded
    Call<BaseMobileBankResponse<BankShebaModel>> getShebaNumberByDeposit(@Header("ParsianAuth") String token,
                                                                         @Field("deposit_number") String depositNumber);

    @POST("cheque/get-cheque")
    @FormUrlEncoded
    Call<BaseMobileBankResponse<List<BankChequeSingle>>> getChequesList(@Header("ParsianAuth") String token,
                                                                        @Field("deposit_number") String depositNumber,
    ...
    @FormUrlEncoded
    Call<BaseMobileBankResponse<List<BankChequeBookListModel>>> getChequesBookList(@Header("ParsianAuth") String token,
                                                                                   @Field("deposit_number") String depositNumber);

    @POST("deposit/get-statements")
    @FormUrlEncoded
    Call<BaseMobileBankResponse<List<BankHistoryModel>>> getAccountHistory(@Header("ParsianAuth") String token,
                                                                           @Field("deposit_number") String depositNumber,
                                                                           @Field("length") Integer length,
                                                                           @Field("offset") Integer offset,
    ...
    @FormUrlEncoded
    Call<BaseMobileBankResponse<BankCardBalance>> getCardBalance(@Header("ParsianAuth") String token,
                                                                 @Field("pan") String cardNumber,
                                                                 @Field("auth_info") String cardData,
                                                                 @Field("deposit_number") String depositNumber);

    @POST("loan/get-loans")
    Call<BaseMobileBankResponse<List<LoanListModel>>> getLoansList(@Header("ParsianAuth") String token
    ...
    @FormUrlEncoded
    Call<BaseMobileBankResponse<BankServiceLoanDetailModel>> getLoanDetail(@Header("ParsianAuth") String token,
    ...
    @POST("loan/pay-loan")
    @FormUrlEncoded
    Call<BaseMobileBankResponse<BankPayLoanModel>> getPayLoan(@Header("ParsianAuth") String token,
                                                              @Field("loan_number") String loanNumber,
    ...
    @FormUrlEncoded
    Call<BaseMobileBankResponse<BankBlockCheque>> blockCheque(@Header("ParsianAuth") String token,
    ...
    @FormUrlEncoded
    Call<BaseMobileBankResponse> registerCheque(@Header("ParsianAuth") String token,
                                                @Field("deposit_number") String depositNumber,
                                                @Field("number") String number,
                                                @Field("amount") Long amount);

    @POST("book-turn")
    Call<BaseMobileBankResponse> getTakeTurn(@Header("ParsianAuth") String token);

    @POST("card/hot-card")
    @FormUrlEncoded
    Call<BaseMobileBankResponse> hotCard(@Header("ParsianAuth") String token,
                                         @Field("pan") String cardNumber,
    ...
    @POST("notif/activate")
    @FormUrlEncoded
    Call<BaseMobileBankResponse> activateNotification(@Header("ParsianAuth") String token,
                                                      @Field("token") String FcmToken);

    @POST("notif/deactivate")
    @FormUrlEncoded
    Call<BaseMobileBankResponse> deactivateNotification(@Header("ParsianAuth") String token,
                                                        @Field("token") String FcmToken);

    @GET("notif/get-status")
    Call<BaseMobileBankResponse<BankNotificationStatus>> getNotificationStatus(@Header("ParsianAuth") String token);
}
