...
public class RadialProgressView extends View {
    ...
    public RadialProgressView(Context context) {
        ...
        progressPaint.setStrokeWidth(LayoutCreator.dp(3));
        ...
        if (noProgress) {
            ...
            if (progressDiff > 0) {
                ...
                if (progressTime >= 200.0f) {
                    ...
                    animatedProgress = progressAnimationStart + progressDiff * decelerateInterpolator.getInterpolation(progressTime / 200.0f);
                }
            }
    ...
    public void setStrokeWidth(float value) {
        progressPaint.setStrokeWidth(LayoutCreator.dp(value));
    }
