...
public class DeprecatedTheme {
    ...
    private static DeprecatedTheme theme;
    private static Paint maskPaint = new Paint(Paint.ANTI_ALIAS_FLAG);

    public static DeprecatedTheme getInstance() {
        if (theme == null) {
            theme = new DeprecatedTheme();
        }
        return theme;
    }
    ...
    public int getColor(int themeId) {
        switch (themeId) {
            case AMBER:
                return R.color.dayYellowTheme;
            case BLUE:
                return R.color.dayBlueTheme;
            case DARK:
                return R.color.darkTheme;
            case RED:
                return R.color.dayRedTheme;
            case PINK:
                return R.color.darkPinkTheme;
            case PURPLE:
                return R.color.dayCyanTheme;
            case ORANGE:
                return R.color.dayOrangeTheme;
            case DEFAULT:
            default:
                return R.color.dayGreenTheme;
        }
    }
