...
public class AnimCheckBox extends View {
    ...
    private AnimateCheckBox.OnCheckedChangeListener listener;
        ...
        va.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
                ...
                if (value >= 1) {
                    ...
                    isAnim = false;
                    if (listener != null) {
                        listener.onCheckedChanged(AnimCheckBox.this, false);
                    }
                }
                invalidate();
            }
        ...
        va.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
                ...
                if (value >= 1) {
                    ...
                    isAnim = false;
                    if (listener != null) {
                        listener.onCheckedChanged(AnimCheckBox.this, true);
                    }
                    showCorrect();
                }
                invalidate();
    ...
    public void setOnCheckedChangeListener(AnimateCheckBox.OnCheckedChangeListener listener) {
