...
public class PaymentRepository {
    ...
    public void checkOrder(String orderToken, ResponseCallback<CheckOrderResponse> callBack) {
        ...
        new ApiInitializer<CheckOrderResponse>().initAPI(paymentApi.requestCheckOrder(orderToken), callBack);

    }

    public void checkOrderStatus(String orderId, ResponseCallback<CheckOrderStatusResponse> callback) {

        new ApiInitializer<CheckOrderStatusResponse>().initAPI(paymentApi.requestCheckOrderStatus(orderId), callback);
