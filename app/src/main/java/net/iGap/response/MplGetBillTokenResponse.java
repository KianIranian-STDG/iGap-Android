...
public class MplGetBillTokenResponse extends MessageHandler {
    ...
    public void handler() {
        ...
        if (G.onPayment != null) {
            G.onPayment.onBillToken(builder.getStatus(), builder.getToken(), builder.getExpireTime(), builder.getMessage(), builder.getOriginalAmount(), builder.getDiscountAmount(), builder.getOrganizationName());
        }
    }
