...
public class ClientSetDiscoveryItemClickResponse extends MessageHandler {

    public int actionId;
    public Object message;
    public String identity;

    public ClientSetDiscoveryItemClickResponse(int actionId, Object protoClass, String identity) {
