...
/**
 * Created by android3 on 12/26/2016.
 */
...
public class FragmentBlockedUser extends Fragment {
    ...
    private void openDialogTogleBlock(final long userId) {
            ...
            public ViewHolder(View view) {
                ...
                itemView.setOnLongClickListener(new View.OnLongClickListener() {
                    @Override public boolean onLongClick(View v) {
                        ...
                        openDialogTogleBlock(realmResults.get(getPosition()).getId());
                    ...
                    G.handler.post(new Runnable() {
                        @Override public void run() {
                            viewHolder.image.setImageBitmap(
                                com.iGap.helper.HelperImageBackColor.drawAlphabetOnPicture((int) viewHolder.image.getContext().getResources().getDimension(R.dimen.dp60), initials, color));
                        }
                    });
                }
            });
