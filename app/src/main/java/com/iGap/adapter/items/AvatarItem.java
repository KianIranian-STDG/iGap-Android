        ...
        if (avatar.isFileExistsOnLocal()) {
            ...
            if (avatar.isThumbnailExistsOnLocal()) {
                ...
                if (selector != null && fileSize > 0) {
                    HelperDownloadFile.startDownload(avatar.getToken(), avatar.getName(), fileSize, selector, "", new HelperDownloadFile.UpdateListener() {
            ...
            holder.progress.setOnClickListener(new View.OnClickListener() {
                @Override public void onClick(View view) {
                    ...
                    if (HelperDownloadFile.isDownLoading(avatar.getToken())) {
                        ...
                        HelperDownloadFile.startDownload(avatar.getToken(), avatar.getName(), avatar.getSize(), ProtoFileDownload.FileDownload.Selector.FILE, path,
