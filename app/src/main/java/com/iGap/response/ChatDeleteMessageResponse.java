...
public class ChatDeleteMessageResponse extends MessageHandler {
    ...
    @Override
    public void handler() {
        final ProtoChatDeleteMessage.ChatDeleteMessageResponse.Builder chatDeleteMessage =
        ...
        realm.executeTransaction(new Realm.Transaction() {
            ...
            public void execute(Realm realm) {
                RealmClientCondition realmClientCondition = realm.where(RealmClientCondition.class)
                        .equalTo(RealmClientConditionFields.ROOM_ID, chatDeleteMessage.getRoomId())
                        .findFirst();
                ...
                if (realmClientCondition != null) {
                    ...
                    for (RealmOfflineDelete realmOfflineDeleted : realmClientCondition.getOfflineDeleted()) {
                        ...
                        if (realmOfflineDeleted.getOfflineDelete()
                ...
                G.onChatDeleteMessageResponse.onChatDeleteMessage(
                        chatDeleteMessage.getDeleteVersion(), chatDeleteMessage.getMessageId(),
                        chatDeleteMessage.getRoomId(), chatDeleteMessage.getResponse());
            }
        });
        realm.close();
    }
