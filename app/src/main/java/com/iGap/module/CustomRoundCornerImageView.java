...
public class CustomRoundCornerImageView extends ImageView {
    ...
    public CustomRoundCornerImageView(Context context, AttributeSet attrs, int defStyle) {
    ...
    private Drawable resolveResource() {
        ...
        if (mResource != 0) {
            try {
                ...
                Log.w("ddd", "Unable to find resource: " + mResource, e);
                // Don't try again.
                mResource = 0;
            }
        }
        ...
        public static Drawable fromDrawable(Drawable drawable, Resources r) {
            if (drawable != null) {
                ...
                if (bm != null) {
                    ...
                    Log.w("ddd", "Failed to create bitmap from drawable!");
                }
            }
            return drawable;
        }
