...
public class StructUserInfo implements Parcelable {
    ...
    public StructUserInfo(String imageSource, String userName, String lastSeen, String name, String number) {
    ...
    public static final Parcelable.Creator<StructUserInfo> CREATOR = new Parcelable.Creator<StructUserInfo>() {
        @Override
