...
public class ActivityChanelInfo extends AppCompatActivity {
    ...
    private TextView txtLastSeen, txtUserName, titleToolbar, txtBlockContact, txtClearChat, txtBack, txtPhoneNumber;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        titleToolbar = (TextView) findViewById(R.id.chi_txt_titleToolbar);
...
//                            row2.put(ContactsContract.Contacts.Data.MIMETYPE, ContactsContract.CommonDataKinds.StructuredName.CONTENT_ITEM_TYPE);
//                            row2.put(ContactsContract.CommonDataKinds.StructuredName.DISPLAY_NAME_PRIMARY, "8888");
//                            row2.put(ContactsContract.CommonDataKinds.StructuredName.DISPLAY_NAME_SOURCE, "777");
//                            row2.put(ContactsContract.CommonDataKinds.StructuredName.DISPLAY_NAME, "d");
//                            row2.put(ContactsContract.CommonDataKinds.StructuredName.FAMILY_NAME, "c");
//                            row2.put(ContactsContract.CommonDataKinds.StructuredName.GIVEN_NAME, "b");
//                            row2.put(ContactsContract.CommonDataKinds.StructuredName.MIDDLE_NAME, "a");
//                            data.add(row2);
...
//                            Bitmap bmImage = BitmapFactory.decodeFile(G.imageFile.toString());
    ...
    private void showAlertDialog(String message, String positive, String negitive) {
